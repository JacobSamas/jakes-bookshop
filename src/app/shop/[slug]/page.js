...
const bookData = [
  ...
  },
  {
    ...
    price: 13.49,
    description: "A dystopian story about a totalitarian future.",
  },
  {
    slug: "mockingbird",
  ...
  },
  {
    ...
    author: "Jane Austen",
    price: 12.99,
    description: "A romantic story about manners and misunderstandings.",
  },
  {
    slug: "mobydick",
    title: "Moby Dick",
      ...
      <div ref={textRef} className="space-y-6">
        ...
        <div ref={buttonRef} className="flex space-x-6 mt-8">
          <button
            ...
            className="bg-secondary text-white px-8 py-4 rounded-md text-lg font-semibold hover:bg-yellow-500 transition transform hover:scale-105"
          >
            Add to Cart
          </button>
